...
begin
  if (colisao(imgPlayer, imgEnemy01)) or (colisao(imgPlayer, imgEnemy02)) or
    ...
    (colisao(imgPlayer, imgEnemy05)) or (Alive >= 20) then
  begin
    SndPlaySound('songs/EnemyHit.wav', SND_ASYNC);
    barLife.Position := barLife.Position - 4;
    ...
    if (barLife.Position = 0) or (Alive >= 20) then
    begin
...
begin
  ...
  if (Score = 500) and (Level < 2) then
  begin
    Level := Level + 1;
    lblLevel.Caption := 'Level: ' + IntToStr(Level);
  end
  else if (Score = 1000) and (Level < 3) then
  begin
    Level := Level + 1;
    lblLevel.Caption := 'Level: ' + IntToStr(Level);
  end
  else if (Score = 1500) and (Level < 4) then
  begin
    Level := Level + 1;
    lblLevel.Caption := 'Level: ' + IntToStr(Level);
  end
  else if (Score = 2500) and (Level < 5) then
  begin
    Level := Level + 1;
    lblLevel.Caption := 'Level: ' + IntToStr(Level);
  end;
